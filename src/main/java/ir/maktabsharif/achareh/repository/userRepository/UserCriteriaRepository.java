...
public class UserCriteriaRepository {
    ...
    public List<UserDTO> findUsersWithCriteria(String name,
        ...
        criteriaQuery.multiselect(
                ...
                subDuties.get("name"),
                duty.get("name"),
                criteriaBuilder.avg(userScoreJoin.get("range"))
        );
        ...
        if(orderByScore){
            criteriaQuery.orderBy(criteriaBuilder.desc(criteriaBuilder.avg(userScoreJoin.get("range"))));
        }else {
            criteriaQuery.orderBy(criteriaBuilder.asc(criteriaBuilder.avg(userScoreJoin.get("range"))));
        }
